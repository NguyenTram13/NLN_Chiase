  ...
  const getCateProfile = async () => {
    try {
      ...
      const response = await axios({
        url: "/auth/admin/cate-profile/?page=" + page + "&keyword=" + query,
      });
